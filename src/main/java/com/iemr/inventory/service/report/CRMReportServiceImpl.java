...
public class CRMReportServiceImpl implements CRMReportService{
	...
	public String getInwardStockReport(ItemStockEntryReport entryReport) {
		...
		{
			list = itemStockReportRepo.getItemStockEntryReportByFacilityID(entryReport.getStartDate(), entryReport.getEndDate(), entryReport.getFacilityID());
		}
		else
		{
	...
	public String getExpiryReport(ItemStockEntryReport entryReport) {
        ...
        for(Object[] object: list)
        {
        	...
        	if(object !=null)
        	{
        		ExpiryReport report =new ExpiryReport(object[0] != null ? object[0].toString():null, object[1] != null ? object[1].toString():null, 
        				object[2] != null ? object[2].toString():null, object[3] !=null ? object[3].toString():null, object[4] != null ? ((Double) object[4]).doubleValue():null,
        						(Date) (object[5] != null ? object[5]: null),(Integer) (object[6] != null ? object[6]:null));
...
//		Long slNo=1L;
//		for(Object[] reportData : list)
//		{
//			ExpiryReport report =mapper.mapExpiryReport(reportData);
//			report.setSlNo(slNo++);
//			reportList.add(report);
//		}
        return reportList.toString();
	...
	public String getConsumptionReport(ItemStockExitReport exitReport) {
		  ...
		  List<Object[]> list = new ArrayList<Object[]>();
	        ...
	        {
	            list = itemStockReportRepo.getItemStockExitReportByFacilityID(exitReport.getStartDate(), exitReport.getEndDate(), exitReport.getFacilityID());
	        }
	        else
	        {
	        ...
	        for(Object[] obj: list)
	        {
	        	...
	        	{
	        		ConsumptionReport report =new ConsumptionReport(obj[16] !=null ? obj[16].toString():null, (Timestamp)(obj[32] != null ? obj[32]:null), (Integer) (obj[23] != null ? obj[23]:null), obj[26] !=null ? obj[26].toString():null, (Date) (obj[20] != null ? obj[20]: null), 
	        				obj[4] != null ? obj[4].toString():null, obj[14] != null ? obj[14].toString():null, obj[11] != null ? obj[11].toString():null, obj[19] != null ? ((BigDecimal) obj[19]).doubleValue():null,  obj[39] != null ? obj[39].toString():null, obj[38] != null  ? ((BigInteger) obj[38]).toString(): "");
	            report.setSlNo(slNo++);
	            reportList.add(report);
	        	}
	        }
	        //Long slNo=1L;
//	        for(ItemStockExitReport reportData : list)
//	        {
//	            ConsumptionReport report =mapper.mapConsumptionReport(reportData);
//	            report.setSlNo(slNo++);
//	            reportList.add(report);
//	        }
	...
	public String getBenDrugIssueReport(PatientIssueExitReport exitReport) {
		...
		if(exitReport.getFacilityID()!=null)
		{
			list = itemStockReportRepo.getPatientIssueExitReportByFacilityID(exitReport.getStartDate(), exitReport.getEndDate(), exitReport.getFacilityID());
		}
		else
		{
...
//		if(entryReport.getFacilityID()!=null)
//		{
			reports = itemStockReportRepo.getDailyStockDetailReportByFacilityID(todaysDate, todaysDate, entryReport.getFacilityID());
//		}
//		else
//		{
//			reports = itemStockReportRepo.getDailyStockDetailReport(todaysDate, todaysDate);
//		}
		Long slNo=1L;
...
//		if(entryReport.getFacilityID()!=null)
//		{
			reports = itemStockReportRepo.getDailyStockSummaryReportByFacilityID(todaysDate, todaysDate, entryReport.getFacilityID());
//		}
//		else
//		{
//			reports = itemStockReportRepo.getDailyStockSummaryReport(todaysDate, todaysDate);
//		}
		Long slNo=1L;
		for (Object[] objects : reports)
		{
...
//		if(entryReport.getFacilityID()!=null)
//		{
		//SH20094090,passing facility ID as mandatory arguement as SP has been changed
			reports = itemStockReportRepo.getDailyStockDetailReportByFacilityID(startDate, endDate, entryReport.getFacilityID());
//		}
//		else
//		{
//			reports = itemStockReportRepo.getDailyStockDetailReportByFacilityID(startDate, endDate, entryReport.getFacilityID());
//			//reports = itemStockReportRepo.getDailyStockDetailReport(startDate, endDate);
//		}
		Long slNo=1L;
		for (Object[] objects : reports)
		{
...
//		if(entryReport.getFacilityID()!=null)
//		{
//		BU40088124 passing FacilityId as mandatory argument as SP has been changed
			reports = itemStockReportRepo.getDailyStockDetailReportByFacilityID(startDate, endDate, entryReport.getFacilityID());
//		}
//		else
//		{
...
//		for(ItemStockEntryReport reportData : list)
//		{
//			ExpiryReport report =mapper.mapShortExpiryReport(reportData);
//			report.setSlNo(slNo++);
//			reportList.add(report);
//		}
		return reportList.toString();
	...
	public String getTransitReport(ItemStockEntryReport entryReport) {
		...
		if(entryReport.getFacilityID()!=null)
		{
			reports = itemStockReportRepo.getTransitReportByFacilityID(entryReport.getStartDate(), entryReport.getEndDate(), entryReport.getFacilityID());
		}
		else
		{
		...
		for (Object[] objects : reports)
		{
			if (objects != null && objects.length > 0)
			{
				list.add(new TransitReport(slNo ++,(String) objects[0], (String) objects[1], objects[2]!=null ?((Number) objects[2]).doubleValue():null, 
						(Date) objects[3], (String) objects[4], (String) objects[5],
						(Timestamp) objects[6], (Timestamp) objects[7]));
			}
